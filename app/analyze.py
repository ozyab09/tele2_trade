...
def getRequest(url_postfix, method):
    ...
    req = requests.request(method, f'{BASE_URL}?{url_postfix}', headers=headers)
...
def main():
    ...
    while True:
        try:
            r = getRequest(url_postfix='trafficType=voice&volume=50&cost=40&offset=0&limit=50', method='get')
